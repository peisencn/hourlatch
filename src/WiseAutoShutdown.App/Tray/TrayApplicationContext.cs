...
using WiseAutoShutdown.Diagnostics;
using WiseAutoShutdown.SystemEvents;
using WiseAutoShutdown.UI;

namespace WiseAutoShutdown.Tray;
...
public sealed class TrayApplicationContext : ApplicationContext
{
    ...
    private void Evaluate(RestrictionTrigger trigger)
    {
        ...
        try
        {
            ...
            _notifyIcon.Text = $"定时限制 - {StateText(currentState)}";
        }
    ...
    {
        _notifyIcon.BalloonTipTitle = "定时限制";
